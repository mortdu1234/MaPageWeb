...
from ...db.backend.users import get_user_by_username, verify_password, create_user, username_exists
from ...db.backend.joueurs import create_joueur
from ...db.backend.permissions import get_user_permissions
...
class Auth:
    ...
    def login(username: str, password: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            print(f"[DEBUG] user trouvé: {user}")  # None ou tuple ?

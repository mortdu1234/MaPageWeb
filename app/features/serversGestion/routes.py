...
from .backend.manager import ServerManager
from app.config import Config
from app.core.utils.blueprints import make_blueprint

log = logging.getLogger(__name__)

serverhub_bp = make_blueprint("serverhub", __name__, __file__, url_prefix="/serverhub")
...
def hub():
    ...
    return render_template(serverhub_bp.get_templates_path("hub.html"))
...
def server_detail(server_id: str):
    ...
    """
    if Config.MINIGAME_VM_PTERODACTYL_ID and server_id == Config.MINIGAME_VM_PTERODACTYL_ID:
        return redirect(url_for("serverMinijeux.serveur_minijeux_page"))

    # TODO: page de détail générique pas encore implémentée
    abort(404)

...
class GenericServerCard extends HTMLElement {
    connectedCallback() {
        injectCSS('generic-server-card', 'generic-server-card.css');
...
customElements.define('generic-server-card', GenericServerCard);
...
from app.core.db.backend.tasks import (
...
tasks_bp = make_blueprint('tasks', __name__, __file__, url_prefix="/tasks")


@tasks_bp.route('/')
@require_permission("tasks")
def database_page():
    return render_template(tasks_bp.get_templates_path('tasks.html'))
